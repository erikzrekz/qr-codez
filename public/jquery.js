...
! function(a, b) {
    ...
    var B, C = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        D = n.fn.init = function(a, b) {
            ...
            if ("string" == typeof a) {
                ...
                if (c[1]) {
                    if (b = b instanceof n ? b[0] : b, n.merge(this, n.parseHTML(c[1], b && b.nodeType ? b.ownerDocument || b : l, !0)), y.test(c[1]) && n.isPlainObject(b)) for (c in b) n.isFunction(this[c]) ? this[c](b[c]) : this.attr(c, b[c]);
                    return this
                }
    ...
    n.event = {
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (r && (i = r.events)) {
                b = (b || "").match(H) || [""], j = b.length;
                while (j--) if (h = Z.exec(b[j]) || [], o = q = h[1], p = (h[2] || "").split(".").sort(), o) {
    ...
    n.extend({
        clone: function(a, b, c) {
            ...
            if (b) if (c) for (f = f || pb(a), g = g || pb(h), d = 0, e = f.length; e > d; d++) ob(f[d], g[d]);
            else ob(a, h);
        ...
        buildFragment: function(a, b, c, d) {
            ...
            k.textContent = "", m = 0;
            while (e = l[m++]) if ((!d || -1 === n.inArray(e, d)) && (i = n.contains(e.ownerDocument, e), f = pb(k.appendChild(e), "script"), i && nb(f), c)) {
                j = 0;
    ...
    n.fn.extend({
        addClass: function(a) {
            ...
            if (h) for (b = (a || "").match(H) || []; j > i; i++) if (c = this[i], d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(vb, " ") : " ")) {
                f = 0;
